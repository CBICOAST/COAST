                ...
                <tbody>
                    ...
                    if (sizeof($periode)<=0){
                    	...
                    	foreach ($periode as $key => $value) {
                    		...
                    		echo "<td ><a href=\"#\" title=\"Detail\" onclick=\"change_page(this, 'c_resource_timesheet/load_timesheet_periode/".$value['date_period']."/".$value['employee_id']."/rm')\">Timesheet ".$value['EMPLOYEE_NAME']." Periode ".$value['char_period']."</a></td>";
                    		echo "</tr>";
